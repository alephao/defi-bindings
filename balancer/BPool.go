...
// DEFAULTRESERVESRATIO is a free data retrieval call binding the contract method 0x93c88d14.
//
// Solidity: function DEFAULT_RESERVES_RATIO() view returns(uint256)
func (_Balancer *BalancerCaller) DEFAULTRESERVESRATIO(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Balancer.contract.Call(opts, &out, "DEFAULT_RESERVES_RATIO")
...
//
// Solidity: function DEFAULT_RESERVES_RATIO() view returns(uint256)
func (_Balancer *BalancerSession) DEFAULTRESERVESRATIO() (*big.Int, error) {
	return _Balancer.Contract.DEFAULTRESERVESRATIO(&_Balancer.CallOpts)
}

// DEFAULTRESERVESRATIO is a free data retrieval call binding the contract method 0x93c88d14.
//
// Solidity: function DEFAULT_RESERVES_RATIO() view returns(uint256)
func (_Balancer *BalancerCallerSession) DEFAULTRESERVESRATIO() (*big.Int, error) {
	return _Balancer.Contract.DEFAULTRESERVESRATIO(&_Balancer.CallOpts)
}
...
//
// Solidity: function calcInGivenOut(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountOut, uint256 swapFee) pure returns(uint256 tokenAmountIn, uint256 tokenInFee)
func (_Balancer *BalancerCaller) CalcInGivenOut(opts *bind.CallOpts, tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountOut *big.Int, swapFee *big.Int) (struct {
	...
	outstruct.TokenAmountIn = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.TokenInFee = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function calcInGivenOut(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountOut, uint256 swapFee) pure returns(uint256 tokenAmountIn, uint256 tokenInFee)
func (_Balancer *BalancerSession) CalcInGivenOut(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountOut *big.Int, swapFee *big.Int) (struct {
	TokenAmountIn *big.Int
	TokenInFee    *big.Int
}, error) {
...
//
// Solidity: function calcInGivenOut(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountOut, uint256 swapFee) pure returns(uint256 tokenAmountIn, uint256 tokenInFee)
func (_Balancer *BalancerCallerSession) CalcInGivenOut(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountOut *big.Int, swapFee *big.Int) (struct {
	TokenAmountIn *big.Int
	TokenInFee    *big.Int
}, error) {
	return _Balancer.Contract.CalcInGivenOut(&_Balancer.CallOpts, tokenBalanceIn, tokenWeightIn, tokenBalanceOut, tokenWeightOut, tokenAmountOut, swapFee)
...
//
// Solidity: function calcOutGivenIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountIn, uint256 swapFee) pure returns(uint256 tokenAmountOut, uint256 tokenInFee)
func (_Balancer *BalancerCaller) CalcOutGivenIn(opts *bind.CallOpts, tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountIn *big.Int, swapFee *big.Int) (struct {
	...
	outstruct.TokenAmountOut = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.TokenInFee = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function calcOutGivenIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountIn, uint256 swapFee) pure returns(uint256 tokenAmountOut, uint256 tokenInFee)
func (_Balancer *BalancerSession) CalcOutGivenIn(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountIn *big.Int, swapFee *big.Int) (struct {
	TokenAmountOut *big.Int
	TokenInFee     *big.Int
}, error) {
...
//
// Solidity: function calcOutGivenIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 tokenAmountIn, uint256 swapFee) pure returns(uint256 tokenAmountOut, uint256 tokenInFee)
func (_Balancer *BalancerCallerSession) CalcOutGivenIn(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, tokenAmountIn *big.Int, swapFee *big.Int) (struct {
	TokenAmountOut *big.Int
	TokenInFee     *big.Int
}, error) {
	return _Balancer.Contract.CalcOutGivenIn(&_Balancer.CallOpts, tokenBalanceIn, tokenWeightIn, tokenBalanceOut, tokenWeightOut, tokenAmountIn, swapFee)
...
// CalcPoolInGivenSingleOut is a free data retrieval call binding the contract method 0x024eb2e3.
//
// Solidity: function calcPoolInGivenSingleOut(uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountOut, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountIn, uint256 reserves)
func (_Balancer *BalancerCaller) CalcPoolInGivenSingleOut(opts *bind.CallOpts, tokenBalanceOut *big.Int, tokenWeightOut *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountOut *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountIn *big.Int
	Reserves     *big.Int
}, error) {
	var out []interface{}
	err := _Balancer.contract.Call(opts, &out, "calcPoolInGivenSingleOut", tokenBalanceOut, tokenWeightOut, poolSupply, totalWeight, tokenAmountOut, swapFee, reservesRatio)
	...
	outstruct.PoolAmountIn = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.Reserves = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function calcPoolInGivenSingleOut(uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountOut, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountIn, uint256 reserves)
func (_Balancer *BalancerSession) CalcPoolInGivenSingleOut(tokenBalanceOut *big.Int, tokenWeightOut *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountOut *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountIn *big.Int
	Reserves     *big.Int
}, error) {
	return _Balancer.Contract.CalcPoolInGivenSingleOut(&_Balancer.CallOpts, tokenBalanceOut, tokenWeightOut, poolSupply, totalWeight, tokenAmountOut, swapFee, reservesRatio)
}

// CalcPoolInGivenSingleOut is a free data retrieval call binding the contract method 0x024eb2e3.
//
// Solidity: function calcPoolInGivenSingleOut(uint256 tokenBalanceOut, uint256 tokenWeightOut, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountOut, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountIn, uint256 reserves)
func (_Balancer *BalancerCallerSession) CalcPoolInGivenSingleOut(tokenBalanceOut *big.Int, tokenWeightOut *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountOut *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountIn *big.Int
	Reserves     *big.Int
}, error) {
	return _Balancer.Contract.CalcPoolInGivenSingleOut(&_Balancer.CallOpts, tokenBalanceOut, tokenWeightOut, poolSupply, totalWeight, tokenAmountOut, swapFee, reservesRatio)
...
// CalcPoolOutGivenSingleIn is a free data retrieval call binding the contract method 0x21abba01.
//
// Solidity: function calcPoolOutGivenSingleIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountIn, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountOut, uint256 reserves)
func (_Balancer *BalancerCaller) CalcPoolOutGivenSingleIn(opts *bind.CallOpts, tokenBalanceIn *big.Int, tokenWeightIn *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountIn *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountOut *big.Int
	Reserves      *big.Int
}, error) {
	var out []interface{}
	err := _Balancer.contract.Call(opts, &out, "calcPoolOutGivenSingleIn", tokenBalanceIn, tokenWeightIn, poolSupply, totalWeight, tokenAmountIn, swapFee, reservesRatio)
	...
	outstruct.PoolAmountOut = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.Reserves = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function calcPoolOutGivenSingleIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountIn, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountOut, uint256 reserves)
func (_Balancer *BalancerSession) CalcPoolOutGivenSingleIn(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountIn *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountOut *big.Int
	Reserves      *big.Int
}, error) {
	return _Balancer.Contract.CalcPoolOutGivenSingleIn(&_Balancer.CallOpts, tokenBalanceIn, tokenWeightIn, poolSupply, totalWeight, tokenAmountIn, swapFee, reservesRatio)
}

// CalcPoolOutGivenSingleIn is a free data retrieval call binding the contract method 0x21abba01.
//
// Solidity: function calcPoolOutGivenSingleIn(uint256 tokenBalanceIn, uint256 tokenWeightIn, uint256 poolSupply, uint256 totalWeight, uint256 tokenAmountIn, uint256 swapFee, uint256 reservesRatio) pure returns(uint256 poolAmountOut, uint256 reserves)
func (_Balancer *BalancerCallerSession) CalcPoolOutGivenSingleIn(tokenBalanceIn *big.Int, tokenWeightIn *big.Int, poolSupply *big.Int, totalWeight *big.Int, tokenAmountIn *big.Int, swapFee *big.Int, reservesRatio *big.Int) (struct {
	PoolAmountOut *big.Int
	Reserves      *big.Int
}, error) {
	return _Balancer.Contract.CalcPoolOutGivenSingleIn(&_Balancer.CallOpts, tokenBalanceIn, tokenWeightIn, poolSupply, totalWeight, tokenAmountIn, swapFee, reservesRatio)
...
// GetReservesRatio is a free data retrieval call binding the contract method 0x4d2fd81d.
//
// Solidity: function getReservesRatio() view returns(uint256)
func (_Balancer *BalancerCaller) GetReservesRatio(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Balancer.contract.Call(opts, &out, "getReservesRatio")
...
//
// Solidity: function getReservesRatio() view returns(uint256)
func (_Balancer *BalancerSession) GetReservesRatio() (*big.Int, error) {
	return _Balancer.Contract.GetReservesRatio(&_Balancer.CallOpts)
}

// GetReservesRatio is a free data retrieval call binding the contract method 0x4d2fd81d.
//
// Solidity: function getReservesRatio() view returns(uint256)
func (_Balancer *BalancerCallerSession) GetReservesRatio() (*big.Int, error) {
	return _Balancer.Contract.GetReservesRatio(&_Balancer.CallOpts)
}
...
// TotalReserves is a free data retrieval call binding the contract method 0x6d0800bc.
//
// Solidity: function totalReserves(address ) view returns(uint256)
func (_Balancer *BalancerCaller) TotalReserves(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Balancer.contract.Call(opts, &out, "totalReserves", arg0)
...
//
// Solidity: function totalReserves(address ) view returns(uint256)
func (_Balancer *BalancerSession) TotalReserves(arg0 common.Address) (*big.Int, error) {
	return _Balancer.Contract.TotalReserves(&_Balancer.CallOpts, arg0)
}

// TotalReserves is a free data retrieval call binding the contract method 0x6d0800bc.
//
// Solidity: function totalReserves(address ) view returns(uint256)
func (_Balancer *BalancerCallerSession) TotalReserves(arg0 common.Address) (*big.Int, error) {
	return _Balancer.Contract.TotalReserves(&_Balancer.CallOpts, arg0)
}
...
// DrainTotalReserves is a paid mutator transaction binding the contract method 0xaeeead66.
//
// Solidity: function drainTotalReserves(address reservesAddress) returns()
func (_Balancer *BalancerTransactor) DrainTotalReserves(opts *bind.TransactOpts, reservesAddress common.Address) (*types.Transaction, error) {
	return _Balancer.contract.Transact(opts, "drainTotalReserves", reservesAddress)
}

// DrainTotalReserves is a paid mutator transaction binding the contract method 0xaeeead66.
//
// Solidity: function drainTotalReserves(address reservesAddress) returns()
func (_Balancer *BalancerSession) DrainTotalReserves(reservesAddress common.Address) (*types.Transaction, error) {
	return _Balancer.Contract.DrainTotalReserves(&_Balancer.TransactOpts, reservesAddress)
}

// DrainTotalReserves is a paid mutator transaction binding the contract method 0xaeeead66.
//
// Solidity: function drainTotalReserves(address reservesAddress) returns()
func (_Balancer *BalancerTransactorSession) DrainTotalReserves(reservesAddress common.Address) (*types.Transaction, error) {
	return _Balancer.Contract.DrainTotalReserves(&_Balancer.TransactOpts, reservesAddress)
}
...
// Seize is a paid mutator transaction binding the contract method 0xeb9253c0.
//
// Solidity: function seize(address token, uint256 amount) returns()
func (_Balancer *BalancerTransactor) Seize(opts *bind.TransactOpts, token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Balancer.contract.Transact(opts, "seize", token, amount)
}

// Seize is a paid mutator transaction binding the contract method 0xeb9253c0.
//
// Solidity: function seize(address token, uint256 amount) returns()
func (_Balancer *BalancerSession) Seize(token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Balancer.Contract.Seize(&_Balancer.TransactOpts, token, amount)
}

// Seize is a paid mutator transaction binding the contract method 0xeb9253c0.
//
// Solidity: function seize(address token, uint256 amount) returns()
func (_Balancer *BalancerTransactorSession) Seize(token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Balancer.Contract.Seize(&_Balancer.TransactOpts, token, amount)
}
...
// SetReservesRatio is a paid mutator transaction binding the contract method 0xb4a8e101.
//
// Solidity: function setReservesRatio(uint256 reservesRatio) returns()
func (_Balancer *BalancerTransactor) SetReservesRatio(opts *bind.TransactOpts, reservesRatio *big.Int) (*types.Transaction, error) {
	return _Balancer.contract.Transact(opts, "setReservesRatio", reservesRatio)
}

// SetReservesRatio is a paid mutator transaction binding the contract method 0xb4a8e101.
//
// Solidity: function setReservesRatio(uint256 reservesRatio) returns()
func (_Balancer *BalancerSession) SetReservesRatio(reservesRatio *big.Int) (*types.Transaction, error) {
	return _Balancer.Contract.SetReservesRatio(&_Balancer.TransactOpts, reservesRatio)
}

// SetReservesRatio is a paid mutator transaction binding the contract method 0xb4a8e101.
//
// Solidity: function setReservesRatio(uint256 reservesRatio) returns()
func (_Balancer *BalancerTransactorSession) SetReservesRatio(reservesRatio *big.Int) (*types.Transaction, error) {
	return _Balancer.Contract.SetReservesRatio(&_Balancer.TransactOpts, reservesRatio)
}
...
// BalancerLOGADDRESERVESIterator is returned from FilterLOGADDRESERVES and is used to iterate over the raw logs and unpacked data for LOGADDRESERVES events raised by the Balancer contract.
type BalancerLOGADDRESERVESIterator struct {
	Event *BalancerLOGADDRESERVES // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BalancerLOGADDRESERVESIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BalancerLOGADDRESERVES)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BalancerLOGADDRESERVESIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BalancerLOGADDRESERVESIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BalancerLOGADDRESERVES represents a LOGADDRESERVES event raised by the Balancer contract.
type BalancerLOGADDRESERVES struct {
	Token          common.Address
	ReservesAmount *big.Int
	Raw            types.Log // Blockchain specific contextual infos
}

// FilterLOGADDRESERVES is a free log retrieval operation binding the contract event 0x9448856d254ce9f0a13e70882297125673303bfaa163fc49ad146aa8bb556607.
//
// Solidity: event LOG_ADD_RESERVES(address indexed token, uint256 reservesAmount)
func (_Balancer *BalancerFilterer) FilterLOGADDRESERVES(opts *bind.FilterOpts, token []common.Address) (*BalancerLOGADDRESERVESIterator, error) {
	...
	logs, sub, err := _Balancer.contract.FilterLogs(opts, "LOG_ADD_RESERVES", tokenRule)
	if err != nil {
		return nil, err
	}
	return &BalancerLOGADDRESERVESIterator{contract: _Balancer.contract, event: "LOG_ADD_RESERVES", logs: logs, sub: sub}, nil
}

// WatchLOGADDRESERVES is a free log subscription operation binding the contract event 0x9448856d254ce9f0a13e70882297125673303bfaa163fc49ad146aa8bb556607.
//
// Solidity: event LOG_ADD_RESERVES(address indexed token, uint256 reservesAmount)
func (_Balancer *BalancerFilterer) WatchLOGADDRESERVES(opts *bind.WatchOpts, sink chan<- *BalancerLOGADDRESERVES, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Balancer.contract.WatchLogs(opts, "LOG_ADD_RESERVES", tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BalancerLOGADDRESERVES)
				if err := _Balancer.contract.UnpackLog(event, "LOG_ADD_RESERVES", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseLOGADDRESERVES is a log parse operation binding the contract event 0x9448856d254ce9f0a13e70882297125673303bfaa163fc49ad146aa8bb556607.
//
// Solidity: event LOG_ADD_RESERVES(address indexed token, uint256 reservesAmount)
func (_Balancer *BalancerFilterer) ParseLOGADDRESERVES(log types.Log) (*BalancerLOGADDRESERVES, error) {
	event := new(BalancerLOGADDRESERVES)
	if err := _Balancer.contract.UnpackLog(event, "LOG_ADD_RESERVES", log); err != nil {
		return nil, err
	}
...
// BalancerLOGDRAINRESERVESIterator is returned from FilterLOGDRAINRESERVES and is used to iterate over the raw logs and unpacked data for LOGDRAINRESERVES events raised by the Balancer contract.
type BalancerLOGDRAINRESERVESIterator struct {
	Event *BalancerLOGDRAINRESERVES // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BalancerLOGDRAINRESERVESIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BalancerLOGDRAINRESERVES)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BalancerLOGDRAINRESERVESIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BalancerLOGDRAINRESERVESIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BalancerLOGDRAINRESERVES represents a LOGDRAINRESERVES event raised by the Balancer contract.
type BalancerLOGDRAINRESERVES struct {
...
// FilterLOGDRAINRESERVES is a free log retrieval operation binding the contract event 0x261074971f6b45f02124a88c43d5c95e174626f867c87684fb60dbbe35ec2cd2.
//
// Solidity: event LOG_DRAIN_RESERVES(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut)
func (_Balancer *BalancerFilterer) FilterLOGDRAINRESERVES(opts *bind.FilterOpts, caller []common.Address, tokenOut []common.Address) (*BalancerLOGDRAINRESERVESIterator, error) {
	...
	logs, sub, err := _Balancer.contract.FilterLogs(opts, "LOG_DRAIN_RESERVES", callerRule, tokenOutRule)
	if err != nil {
		return nil, err
	}
	return &BalancerLOGDRAINRESERVESIterator{contract: _Balancer.contract, event: "LOG_DRAIN_RESERVES", logs: logs, sub: sub}, nil
}

// WatchLOGDRAINRESERVES is a free log subscription operation binding the contract event 0x261074971f6b45f02124a88c43d5c95e174626f867c87684fb60dbbe35ec2cd2.
//
// Solidity: event LOG_DRAIN_RESERVES(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut)
func (_Balancer *BalancerFilterer) WatchLOGDRAINRESERVES(opts *bind.WatchOpts, sink chan<- *BalancerLOGDRAINRESERVES, caller []common.Address, tokenOut []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Balancer.contract.WatchLogs(opts, "LOG_DRAIN_RESERVES", callerRule, tokenOutRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BalancerLOGDRAINRESERVES)
				if err := _Balancer.contract.UnpackLog(event, "LOG_DRAIN_RESERVES", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseLOGDRAINRESERVES is a log parse operation binding the contract event 0x261074971f6b45f02124a88c43d5c95e174626f867c87684fb60dbbe35ec2cd2.
//
// Solidity: event LOG_DRAIN_RESERVES(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut)
func (_Balancer *BalancerFilterer) ParseLOGDRAINRESERVES(log types.Log) (*BalancerLOGDRAINRESERVES, error) {
	event := new(BalancerLOGDRAINRESERVES)
	if err := _Balancer.contract.UnpackLog(event, "LOG_DRAIN_RESERVES", log); err != nil {
		return nil, err
	}
...
// FilterLOGEXIT is a free log retrieval operation binding the contract event 0x9d9058fd2f25ccc389fec7720abef0ca83472f5abfafd5f10d37f51e6a0493f3.
//
// Solidity: event LOG_EXIT(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut, uint256 reservesAmount)
...
// WatchLOGEXIT is a free log subscription operation binding the contract event 0x9d9058fd2f25ccc389fec7720abef0ca83472f5abfafd5f10d37f51e6a0493f3.
//
// Solidity: event LOG_EXIT(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut, uint256 reservesAmount)
...
// ParseLOGEXIT is a log parse operation binding the contract event 0x9d9058fd2f25ccc389fec7720abef0ca83472f5abfafd5f10d37f51e6a0493f3.
//
// Solidity: event LOG_EXIT(address indexed caller, address indexed tokenOut, uint256 tokenAmountOut, uint256 reservesAmount)
...
// FilterLOGJOIN is a free log retrieval operation binding the contract event 0x15a8ca63e37b2cff1677df2b6b82d36fcf8a524228bd7a4b4d02d107c28c1e8a.
//
// Solidity: event LOG_JOIN(address indexed caller, address indexed tokenIn, uint256 tokenAmountIn, uint256 reservesAmount)
...
// WatchLOGJOIN is a free log subscription operation binding the contract event 0x15a8ca63e37b2cff1677df2b6b82d36fcf8a524228bd7a4b4d02d107c28c1e8a.
//
// Solidity: event LOG_JOIN(address indexed caller, address indexed tokenIn, uint256 tokenAmountIn, uint256 reservesAmount)
...
// ParseLOGJOIN is a log parse operation binding the contract event 0x15a8ca63e37b2cff1677df2b6b82d36fcf8a524228bd7a4b4d02d107c28c1e8a.
//
// Solidity: event LOG_JOIN(address indexed caller, address indexed tokenIn, uint256 tokenAmountIn, uint256 reservesAmount)
...
// FilterLOGSWAP is a free log retrieval operation binding the contract event 0x50ef2fc267012b5c84b56835f16ffd5331ac5a151a3760d74908721ba78b0efe.
//
// Solidity: event LOG_SWAP(address indexed caller, address indexed tokenIn, address indexed tokenOut, uint256 tokenAmountIn, uint256 tokenAmountOut, uint256 reservesAmount)
...
// WatchLOGSWAP is a free log subscription operation binding the contract event 0x50ef2fc267012b5c84b56835f16ffd5331ac5a151a3760d74908721ba78b0efe.
//
// Solidity: event LOG_SWAP(address indexed caller, address indexed tokenIn, address indexed tokenOut, uint256 tokenAmountIn, uint256 tokenAmountOut, uint256 reservesAmount)
...
// ParseLOGSWAP is a log parse operation binding the contract event 0x50ef2fc267012b5c84b56835f16ffd5331ac5a151a3760d74908721ba78b0efe.
//
// Solidity: event LOG_SWAP(address indexed caller, address indexed tokenIn, address indexed tokenOut, uint256 tokenAmountIn, uint256 tokenAmountOut, uint256 reservesAmount)
